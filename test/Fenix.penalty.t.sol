...
contract FenixPenaltyTest is Test {
    ...
    function testCalculateEarlyPenalty() public {
        ...
        Stake memory stake1 = Stake(Status.ACTIVE, blockTs, 0, 100, base, bonus, base + bonus, 0);
    ...
    function testCalculateLatePenalty() public {
        ...
        uint40 blockTs = uint40(block.timestamp);
        Stake memory stake1 = Stake(Status.ACTIVE, blockTs, 0, uint16(baseTerm), base, bonus, base + bonus, 0);
